...
(1, 'Akidah', 'Soalan 2', 1, 'Nyatakan maksud Akidah Ahli Sunnah Wal Jamaah (ASWJ)', 2, 'Golongan majoriti umat Islam yang berpegang teguh kepada al-Quran dan al-Sunnah mengikut pemahaman Rasulullah SAW, para sahabat, tabi''in dan ulama salaf. (Isi + huraian)', ARRAY['SBP (tidak disahkan)']::text[], 'SPM 2024'),
(2, 'Akidah', 'Soalan 2', 2, 'Nyatakan EMPAT nama lain bagi Ahli Sunnah Wal Jamaah', 2, '1. Ahlul Athar / 2. Ahlul Hadis / 3. al-Firqah al-Najiyah / 4. al-Thaifah al-Mansurah', ARRAY['SBP (tidak disahkan)']::text[], 'SPM 2024'),
...
(4, 'Akidah', 'Soalan 2', 4, 'Apakah maksud nama Allah al-Raqib? Berikan SATU bukti bahawa Allah bersifat al-Raqib', 4, 'Maksud: Allah Maha Mengawasi segala perbuatan makhluk-Nya. Bukti: Surah al-Nisa'' ayat 1 / Malaikat Raqib dan Atid mencatat amalan manusia', ARRAY['SBP (tidak disahkan)']::text[], 'SPM 2023'),
(5, 'Akidah', 'Soalan 2', 5, 'Nyatakan DUA tindakan yang perlu dilakukan oleh seseorang yang beriman dengan nama Allah al-Syahid', 2, '1. Sentiasa berhati-hati dalam perkataan dan perbuatan kerana Allah menyaksikan segalanya / 2. Melaksanakan ibadat dengan ikhlas walaupun tiada orang melihat', ARRAY['SBP (tidak disahkan)']::text[], 'SPM 2022'),
(6, 'Akidah', 'Soalan 2', 6, 'Jelaskan maksud Fiqh al-Aulawiyat dan nyatakan DUA prinsip asasnya', 4, 'Maksud: Ilmu mengutamakan amalan yang lebih penting berdasarkan skala keutamaan Islam. Prinsip: 1. Mendahulukan fardu berbanding sunat / 2. Mendahulukan maslahah yang lebih besar', ARRAY['SBP (tidak disahkan)']::text[], 'SPM 2022'),
...
(8, 'Hadis', 'Soalan 1', 2, 'Terangkan DUA pengajaran daripada hadis tujuh golongan mendapat naungan Allah', 4, '1. Pemimpin wajib adil — kepimpinan adalah amanah besar / 2. Amalan ikhlas secara rahsia lebih bernilai — jauhkan sifat riak dalam beramal', ARRAY['SBP (tidak disahkan)']::text[], 'SPM 2022'),
(9, 'Hadis', 'Soalan 1', 3, 'Apakah maksud berdikari? Nyatakan DUA kelebihannya dari aspek agama', 4, 'Maksud: Berusaha sendiri tanpa bergantung kepada orang lain secara tidak perlu. Kelebihan: 1. Elak meminta-minta yang menjatuhkan maruah Muslim / 2. Mencerminkan tawakkal yang betul', ARRAY['SBP (tidak disahkan)']::text[], 'SPM 2024'),
...
(12, 'Fiqah', 'Soalan 3', 1, 'Nyatakan LIMA rukun nikah dalam perkahwinan Islam', 2, '1. Pengantin lelaki / 2. Pengantin perempuan / 3. Wali / 4. Dua orang saksi / 5. Ijab dan qabul', ARRAY['SBP (tidak disahkan)']::text[], 'SPM 2023'),
(13, 'Fiqah', 'Soalan 3', 2, 'Jelaskan DUA syarat sah wali dalam perkahwinan Islam', 4, '1. Islam — bukan Islam tidak sah menjadi wali / 2. Lelaki — perempuan tidak boleh menjadi wali dalam akad nikah', ARRAY['SBP (tidak disahkan)']::text[], 'SPM 2023'),
(14, 'Fiqah', 'Soalan 3', 3, 'Terangkan DUA hikmah pensyariatan hukum faraid dalam Islam', 4, '1. Memastikan pembahagian harta pusaka adil — kekalkan silaturrahim / 2. Melindungi hak waris yang lemah seperti anak-anak kecil dan wanita', ARRAY['SBP (tidak disahkan)']::text[], 'SPM 2023'),
(15, 'Fiqah', 'Soalan 3', 4, 'Nyatakan maksud haji dari segi istilah dan jelaskan DUA syarat wajib haji', 4, 'Maksud: Menziarahi Baitullah di Makkah pada waktu tertentu dengan syarat yang ditetapkan. Syarat: 1. Islam / 2. Berakal', ARRAY['SBP (tidak disahkan)']::text[], 'SPM 2023'),
(16, 'Fiqah', 'Soalan 3', 5, 'Apakah maksud judi? Berikan DUA contoh perbuatan judi dalam kehidupan moden', 4, 'Maksud: Permainan atau pertaruhan yang mengandungi unsur untung-rugi secara tidak pasti. Contoh: 1. Membeli nombor ekor / 2. Bertaruh wang dalam permainan kad atau sukan', ARRAY['SBP (tidak disahkan)']::text[], 'SPM 2024'),
(17, 'Fiqah', 'Soalan 3', 6, 'Nyatakan DUA perbezaan ibadat korban dan akikah', 4, '1. Masa: Korban (10-13 Zulhijjah) — Akikah (hari ke-7 selepas kelahiran) / 2. Tujuan: Korban (mendekatkan diri kepada Allah) — Akikah (syukur atas kelahiran anak)', ARRAY['SBP (tidak disahkan)']::text[], 'SPM 2022 & 2023'),
...
(87, 'Sirah', 'Soalan 4 (b/c)', 22, 'Nyatakan DUA ketinggian akhlak Hassan al-Banna dalam perjuangannya', 4, '1. Sabar dan tabah menghadapi tekanan — teruskan dakwah walaupun diancam / 2. Ikhlas berjuang semata-mata kerana Allah', ARRAY['SBP (tidak disahkan)']::text[], 'SPM 2024'),
